                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <div x-data="themeSwitcher()" x-init="switchTheme()" @keydown.window.tab="switchOn = false"
                                class="flex justify-center items-center my-2 space-x-2">
                                <label class="inline-flex items-center relative cursor-pointer">
                                    <input id="toggle" type="checkbox" class="peer hidden" x-model="switchOn"
                                        @change="switchTheme()" />
                                    <div
                                    ...
                                    <svg height="0" width="100" viewBox="0 0 24 24" data-name="Layer 1"
                                    ...
                                    <svg height="512" width="512" viewBox="0 0 24 24" data-name="Layer 1"
                                        id="Layer_1" xmlns="http://www.w3.org/2000/svg"
